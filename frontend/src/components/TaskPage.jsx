...
export default function TaskPage() {
  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        const res = await axios.get("https://backend-alpha-five-96.vercel.app/api/tasks", {
  ...
  const completeTask = async (id) => {
    setLoading(true);
    try {
      await axios.put(`https://backend-alpha-five-96.vercel.app/api/tasks/${id}/complete`);
      setTasks((old) =>
