...
function AdminPage() {
  ...
  useEffect(() => {
    ...
    axios.get("https://backend-alpha-five-96.vercel.app/api/attendance/dates-in-month", { params: { month: monthStr } })
      .then(res => setAttendanceMarkedDates(res.data || []));
  }, [attendanceMonth]);

  useEffect(() => {
    setLoading(true);
    axios.get("https://backend-alpha-five-96.vercel.app/api/attendance/all", { params: { date: selectedDate } })
  ...
  useEffect(() => {
    ...
    axios.get("https://backend-alpha-five-96.vercel.app/api/tasks/dates-in-month", { params: { month: monthStr } })
      .then(res => setTasksMarkedDates(res.data || []));
  }, [taskMonth]);

  useEffect(() => {
    setLoading(true);
    axios.get("https://backend-alpha-five-96.vercel.app/api/tasks/all", { params: { date: selectedTaskDate } })
  ...
  const handleDuplicateTasks = async () => {
    ...
    try {
      await axios.post("https://backend-alpha-five-96.vercel.app/api/tasks/duplicate-to-end-of-month", {
      ...
      const dres = await axios.get("https://backend-alpha-five-96.vercel.app/api/tasks/dates-in-month", { params: { month: monthStr } });
  ...
  const handleDeleteTask = async (taskId) => {
    ...
    try {
      await axios.delete(`https://backend-alpha-five-96.vercel.app/api/tasks/${taskId}`);
  ...
  useEffect(() => {
    setLoading(true);
    axios.get("https://backend-alpha-five-96.vercel.app/api/events")
  ...
  const handleCreateEvent = async () => {
    try {
      ...
      const evRes = await axios.get("https://backend-alpha-five-96.vercel.app/api/events");
